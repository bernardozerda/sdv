...
// DATOS ACTOS ADMINISTRATIVOS
		$sqlAAD = mysql_query("SELECT T_AAD_HOGARES_VINCULADOS.numActo as acto,
								...
								FROM ((sdht_subsidios.T_AAD_HOGARES_VINCULADOS T_AAD_HOGARES_VINCULADOS
									LEFT JOIN sdht_subsidios.T_AAD_FORMULARIO_ACTO t_aad_formulario_acto ON (T_AAD_HOGARES_VINCULADOS.seqFormularioActo = t_aad_formulario_acto.seqFormularioActo))
									LEFT JOIN sdht_subsidios.t_aad_tipo_acto t_aad_tipo_acto ON (T_AAD_HOGARES_VINCULADOS.seqTipoActo = t_aad_tipo_acto.seqTipoActo))
									LEFT JOIN sdht_subsidios.t_frm_modalidad t_frm_modalidad ON (t_frm_modalidad.seqModalidad = t_aad_formulario_acto.seqModalidad)
