    ...
    <!-- ********************************************************** 
        PLANTILLA DE POSTULACION BOGOTA POSITIVA,
    ...
    *************************************************************** -->
    ...
    {else}
        ...
        <!-- OTRO ESQUEMA -->
        {assign var=txtFuncion   value="pedirConfirmacion('mensajes',this,'./contenidos/subsidios/pedirConfirmacionBp.php')"}
        {assign var=txtImpresion value="imprimirPostulacion( document.frmPostulacion );"}
    {/if}

    <form name="frmPostulacion" 
          id="frmPostulacion"
          onSubmit="{$txtFuncion}; return false;" 
          autocomplete=off 
    >	

<!-- CODGIO PARA EL POP UP DE SEGUIMIENTO Y BOTON SUBMIT DEL FORMULARIO -->
...
<!-- FORMULARIO DE POSTULACION -->	    
        <div id="frm" style="height:510px;">
            ...
            <p><table cellspacing="2" cellpadding="0" border="0" width="100%">
                <tr>
                    <td height="22px" style="padding-left:10px;" width="105px"><b>Estado</b></td>
...
<!-- COMPOSICION FAMILIAR -->				    
                    <div id="composicion" style="height:420px; overflow:auto;"><p>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#FFFFFF">
                            <tr>
                                <td style="padding-right:15px;" align="right" height="20px" valign="middle" bgcolor="#CCCCCC">
                            ...
                            <tr>
                                <td id="agregarMiembro" style="display: none;">
                                    ...
                                    <!-- FILA OCULTA DE AGREGAR MIEMBROS DE HOGAR -->
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left:4px">
                                                <input	type="text" 
                                                       ...
                                                       value=""
                                                       readonly
                                                /> <a onClick="calendarioPopUp('fechaNac')" href="#">Calendario</a><br>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4" align="right" height="25px" valign="top" style="padding-right:10px">
                                                <img src="./recursos/imagenes/bullet.jpg" 
                                                     ...
                                                     onClick="agregarMiembroHogarBp();"
                                                     />&nbsp;
                                                <a href="#" onClick="agregarMiembroHogarBp();">Agregar</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td></tr>
                                ...
                                <td valign="top" align="left">
                                    <div id="barrioAutocomplete" style="width:200px;">
                                        <input	type="text" 
                                               ...
                                               style="width:260px"
                                               />
                                        <div id="barrioContainer" style="width:260px"></div>
                                    </div>
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td width="260px">
                                    <select	onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                            onBlur="this.style.backgroundColor = '#FFFFFF';" 
                                            onChange="
                                                cargarContenido( 'tdTipoSolucion' , './contenidos/subsidios/tipoSolucion.php' , 'postulacion=1&modalidad=' + this.options[ this.selectedIndex ].value , true ); 
...
<!-- ACTOS ADMINISTRATIVOS -->	        
    ...
    <input type="hidden" name="txtArchivo" value="./contenidos/subsidios/salvarPostulacionBp.php">
