        ...
        <div class="yui-content">
            ...
            <div id="frm" style="height:510px;">
                ...
                <div id="pestanasPostulacion" class="yui-navset" style="width:100%; text-align:left;">
                    <ul class="yui-nav">
                        <li><a href="#composicion"><em>Composición Familiar</em></a></li>
                        ...
                        <li class="selected"><a href="#movilizacion"><em>Generar Carta de Movilización</em></a></li>
                    </ul>            
                    <div class="yui-content">
               ...
               />
                        ...
                        <div id="movilizacion" style="height:407px;"><p>
                            <table cellpadding="1" cellspacing="0" border="0" width="100%" bgcolor="#FFFFFF" height='50%'>
                                ...
                                <tr>
                                    <!-- TIENE AHORRO -->                                   
                                    <td><input type="radio" value="1" name="radio" id="radio_1"> Ahorro 1 </td>
                                    <td align="left" style="padding-right: 5px;">
                                        $ <input	type="text" 
                                                 name="valSaldoCuentaAhorro_1" 
                                                 id="valSaldoCuentaAhorro_1" 
                                                 value="{$objFormulario->valSaldoCuentaAhorro|number_format:'0':'.':'.'}" 
                                                 onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                                 onBlur="soloNumeros(this);
                                                         this.style.backgroundColor = '#FFFFFF';
                                    ...
                                    <td align="center" width="320px">
                                        <select onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                                onBlur="this.style.backgroundColor = '#FFFFFF';"  
                                                name="seqBancoCuentaAhorro_1" 
                                                id="seqBancoCuentaAhorro_1" 
                                                style="width:300px;"
                                                >
                                            <option value="1">Ninguno</option>
                                            {foreach from=$arrBanco key=seqBanco item=txtBanco}
                                ...
                                <tr>
                                    <!-- TIENE OTRO AHORRO -->                                    
                                    <td><input type="radio" value="2" name="radio" id="radio_2"> Ahorro 2</td>
                                    <td align="left" style="padding-right: 5px;">
                                        $ <input type="text" 
                                                 name="valSaldoCuentaAhorro2" 
                                                 id="valSaldoCuentaAhorro_2" 
                                                 value="{$objFormulario->valSaldoCuentaAhorro2|number_format:'0':'.':'.'}" 
                                                 onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                                 onBlur="soloNumeros(this);
                                                         this.style.backgroundColor = '#FFFFFF';
                                    ...
                                    <td align="center" width="320px">
                                        <select onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                                onBlur="this.style.backgroundColor = '#FFFFFF';"  
                                                name="seqBancoCuentaAhorro_2" 
                                                id="seqBancoCuentaAhorro_2" 
                                                style="width:300px;"
                                                >
                                            <option value="1">Ninguno</option>
                                            {foreach from=$arrBanco key=seqBanco item=txtBanco}
                                ...
                                <tr>
                                    <!-- TIENE OTRO AHORRO -->                                    
                                    <td><input type="radio" value="3" name="radio" id="radio_3"> otro</td>
                                    <td align="left" style="padding-right: 5px;">
                                        $ <input	type="text" 
                                                 name="valSaldoCuentaAhorro_3" 
                                                 id="valSaldoCuentaAhorro_2" 
                                                 value="" 
                                                 onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                                 onBlur="soloNumeros(this);
                                ...
                                <tr>
                                    <td colspan="4" style="text-align: center" ><br>
                                        ...
                                        <div onclick="confirmarCartaMovilizacion({$numDocumento}, 1)" style="width:70px; text-align: center; border: 1px solid #000; background: #F5F5F5; position: relative; left: 44% ">
