                        ...
                        <p>
                           <form id="frmFuncionarios" class="form-horizontal" method="post" action="./autenticacion.php" autocomplete="off">
                              <fieldset>
                                 ...
                                 <div class="control-group">
                                    <div class="controls">
                                       <img id="imagenCaptcha" src="{$txtRutaCaptcha}?width={$numAncho}&height={$numAlto}&characters={$numLetras}" alt="captcha" />
                                       <a href="#" onClick="cambiarImagenCaptcha('{$txtRutaCaptcha}?width={$numAncho}&height={$numAlto}&characters={$numLetras}');">
