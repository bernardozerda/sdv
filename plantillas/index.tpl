                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="position: relative; top: 10px; height: 80px; width: 900px"><img src="./recursos/imagenes/cabezote_ws.png" width="900px">
                                                                ...
                                                                <div style="position: absolute; width: 24%; float: left; top: 8px;left:98%;">
                                        ...
                                        <footer>
                                            <div class="well well-small" >
                                                <center>
                                                        ...
                                                        <div style=" width:450px;"><img src="./recursos/imagenes/background_menupie.png" width="450px" height="20px"/></div>
