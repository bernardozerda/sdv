<?php /* Smarty version 2.6.26, created on 2017-03-22 18:12:33
         compiled from cruces/cruces.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'upper', 'cruces/cruces.tpl', 21, false),)), $this); ?>
<?php 
    ...
    <tr>
        ...
        <td width="150px" valign="top" style="padding-right:5px; border-right: 1px dotted #999999;">
                ...
                <div style="padding:5px; height:94%; overflow:auto;">
                    <?php $_from = $this->_tpl_vars['arrCruces']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['seqCruce'] => $this->_tpl_vars['arrInfo']):
?>
                        <li style="cursor: pointer; padding-bottom: 2px; border-bottom: 1px dotted #999999;"
                            ...
                            onClick="cargarContenido('listado','./contenidos/cruces/leerCruce.php','seqCruce=<?php echo $this->_tpl_vars['seqCruce']; ?>
',true);"
                        >
                            <?php echo ((is_array($_tmp=$this->_tpl_vars['arrInfo']['nombre'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
        ...
        >
            <table border="0" cellpadding="3" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <input type="textbox" name="elaboro" value="<?php echo $this->_tpl_vars['txtUsuario']; ?>
" style="width:300px">
                    </td>
                </tr>
