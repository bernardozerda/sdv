...
<?php else: ?>
    <?php $this->assign('seqEstadoProceso', 37); ?>
<?php endif; ?>


<!-- si es por el esquema de casa en mano la funcion de submit es diferente -->
<?php if (isset ( $this->_tpl_vars['txtArchivoCEM'] ) && trim ( $this->_tpl_vars['txtArchivoCEM'] ) != ""): ?>

    <!-- CASA EN MANO -->
    <?php $this->assign('txtFuncion', "someterFormulario('mensajes',this,'./contenidos/casaMano/pedirConfirmacion.php',false,true)"); ?>
    <?php $this->assign('txtImpresion', "imprimirPostulacionCEM( document.frmPostulacion , './contenidos/casaMano/pedirConfirmacion.php' );"); ?>
<?php else: ?>

    <!-- OTRO ESQUEMA -->
    <?php $this->assign('txtFuncion', "pedirConfirmacion('mensajes',this,'./contenidos/subsidios/pedirConfirmacion.php')"); ?>
<?php endif; ?>

<form name="frmPostulacion" 
      id="frmPostulacion"
      onSubmit="<?php echo $this->_tpl_vars['txtFuncion']; ?>
;
              return false;" 
      autocomplete=off 
      >	
                ...
                <table cellspacing="0" cellpadding="3" border="0">
                    <tr>
                        ...
                        <td style="width:350px;" align="left">
                            <?php if ($this->_tpl_vars['objFormulario']->seqEstadoProceso == 36): ?>
                                <?php echo $this->_tpl_vars['arrEstado']['36']; ?>
                                ...
                                <select onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                        ...
                                        >
                                    <!--<option value="36" <?php if ($this->_tpl_vars['seqEstadoProceso'] == 36): ?> selected <?php endif; ?>>
                                    <?php echo $this->_tpl_vars['arrEstado']['36']; ?>

                                </option>-->
                                    <option value="37" <?php if ($this->_tpl_vars['seqEstadoProceso'] == 37): ?> selected <?php endif; ?>>
                                        <?php echo $this->_tpl_vars['arrEstado']['37']; ?>

                                    </option>
                                </select>
                            <?php elseif ($this->_tpl_vars['objFormulario']->seqEstadoProceso == 37): ?>
                                <select onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                        onBlur="this.style.backgroundColor = '#FFFFFF';" 
                                        name="seqEstadoProceso"
                                        id="seqEstadoProceso"
                            ...
                            <?php elseif (isset ( $this->_tpl_vars['arrEstadosCEM'] ) && is_array ( $this->_tpl_vars['arrEstadosCEM'] ) && in_array ( $this->_tpl_vars['objFormulario']->seqEstadoProceso , $this->_tpl_vars['arrEstadosCEM']['adelante'] )): ?>
                                <select name="seqEstadoProceso" 
                                    ...
                                    <optgroup label="Retorno">
                                        <?php $_from = $this->_tpl_vars['arrEstadosCEM']['atras']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
"><?php echo $this->_tpl_vars['arrEstados'][$this->_tpl_vars['seqEstado']]; ?>
                                    ...
                                    <optgroup label="Avance">
                                        <?php $_from = $this->_tpl_vars['arrEstadosCEM']['adelante']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['seqEstado']):
?>
                                            <option value="<?php echo $this->_tpl_vars['seqEstado']; ?>
"
                                                    <?php if ($this->_tpl_vars['seqEstado'] == $this->_tpl_vars['objFormulario']->seqEstadoProceso): ?> selected <?php endif; ?>
                                                    >
                                                <?php echo $this->_tpl_vars['arrEstados'][$this->_tpl_vars['seqEstado']]; ?>
...
">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <select onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                                            onBlur="this.style.backgroundColor = '#FFFFFF';" 
                                                            onchange="selectAnidados('<?php echo $this->_tpl_vars['objCiudadano']->numDocumento; ?>
', 0);"
                                                            id="nivelEducativo" 
                                                            style="width:90%;"
                                                            >
...
">
                                        <input type="hidden" id="<?php echo $this->_tpl_vars['objCiudadano']->numDocumento; ?>
-anosAprobados" name="hogar[<?php echo $this->_tpl_vars['objCiudadano']->numDocumento; ?>
][anosAprobados]" value="<?php echo $this->_tpl_vars['objCiudadano']->numAnosAprobados; ?>
">
                                        <input type="hidden" id="<?php echo $this->_tpl_vars['objCiudadano']->numDocumento; ?>
-afiliacionSalud" name="hogar[<?php echo $this->_tpl_vars['objCiudadano']->numDocumento; ?>
][afiliacionSalud]" value="<?php echo $this->_tpl_vars['objCiudadano']->numAfiliacionSalud; ?>
">
...
">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" name="numCohabitacion" autofocus="" size="4" maxlength="3" min="0" step="1" style="width: 40px" value="<?php echo $this->_tpl_vars['objFormulario']->numHabitaciones; ?>
"></td>
                                    <td>Hacinamiento. Número Dormitorios</td>
                                    <td><input type="number" name="numHacinamiento" autofocus="" size="4" maxlength="3" min="0" step="1" style="width: 40px" value="<?php echo $this->_tpl_vars['objFormulario']->numHacinamiento; ?>
"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:10px;">
                                        <select	onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                                ...
                                                style="width:100%;"
                                                >
                                            <option value="0" <?php if ($this->_tpl_vars['objFormulario']->bolSecMujer != 1): ?> selected <?php endif; ?> >No</option>
                                            <option value="1" <?php if ($this->_tpl_vars['objFormulario']->bolSecMujer == 1): ?> selected <?php endif; ?> >Si</option>
                                        </select>
                                    </td>
...
"
                                        ...
                                        <input type="hidden" name="seqProyectoHijo" id="seqProyectoHijo" value ="<?php echo $this->_tpl_vars['objFormulario']->seqProyectoHijo; ?>
">
                                        <input type="hidden" name="seqUnidadProyecto" id="seqUnidadProyecto" value ="<?php echo $this->_tpl_vars['objFormulario']->seqUnidadProyecto; ?>
">
...
">
                                ...
                                <?php if ($this->_tpl_vars['nombreConjunto'] != ''): ?>
                                    <tr>
                                        <td>Conjunto Residencial</td>
                                        <td colspan="3" align="left"><?php echo $this->_tpl_vars['nombreConjunto']; ?>
</td>
                                    </tr>
                                <?php endif; ?>
                                <!-- UNIDAD RESIDENCIAL :: Jaison Ospina :: 13-01-2016 -->
                                <?php if ($this->_tpl_vars['nombreUnidad'] != ''): ?>
                                    <tr>
                                        <td>Unidad Residencial</td>
                                        <td colspan="3" align="left"><?php echo $this->_tpl_vars['nombreUnidad']; ?>
</td>
                                    </tr>
                                <?php endif; ?>
                                <!-- DIRECCION SOLUCION-->
...
" 
                            ...
                            <?php if (trim ( $this->_tpl_vars['txtArchivoCEM'] ) == ""): ?>
                                <table cellpadding="3" cellspacing="0" border="0" width="100%" style="border: 1px dotted #666666">
                                    <tr>	
...
">
        <input type="hidden" name="txtFase" value="<?php echo $this->_tpl_vars['arrFlujoHogar']['fase']; ?>
">
        <input type="hidden" name="txtFlujo" value="<?php echo $this->_tpl_vars['arrFlujoHogar']['flujo']; ?>
">
    <?php endif; ?>
