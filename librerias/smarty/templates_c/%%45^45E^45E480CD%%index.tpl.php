<?php /* Smarty version 2.6.26, created on 2017-04-04 12:46:05
                ...
                <tr>
                    <td>
                        <div style="position: relative; top: 10px; height: 80px; width: 900px"><img src="./recursos/imagenes/cabezote_ws.png" width="900px">
                                ...
                                <div style="position: absolute; width: 30%; float: left; top: 5px;left:41%;"> <b><i>En sesión:</b> <?php echo $this->_tpl_vars['txtNombreUsuario']; ?>
</i></div>   
                    ...
                    <!-- <td rowspan="2" valign="bottom" >
                         <img src="<?php echo $this->_tpl_vars['txtRutaImagenes']; ?>
logoPive.png" align="center" onClick="location.reload(true);" style="cursor:pointer;"/>
                     </td>
