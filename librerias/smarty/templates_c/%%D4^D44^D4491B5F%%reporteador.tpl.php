<?php /* Smarty version 2.6.26, created on 2017-03-09 12:19:57
         compiled from reportes/reporteador.tpl */ ?>
<form id="reporteador">
				    ...
				    <div class="yui-content">
					    <div id="tabReporteTipos">
							<table cellpadding="3" cellspacing="0" border="0" width="100%">
								...
								<tr><td><input type="checkbox" id="rPPal" checked name="criterioPPal" value="1"> Postulante Principal</td></tr>
							...
							<tr>
								...
								<td align="center" width="240px">
									...
									<select	id="wCampo" 
										...
										onChange="cambioWSelect( this.options[ this.selectedIndex ].value )"
									>
										<option value="">Seleccione Campo</option>
										<?php $_from = $this->_tpl_vars['arrCamposGrupos']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['idCampoGrupo'] => $this->_tpl_vars['arrCampos']):
?>
											<optgroup label="<?php echo $this->_tpl_vars['idCampoGrupo']; ?>
">
											<?php $_from = $this->_tpl_vars['arrCampos']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['idCampo'] => $this->_tpl_vars['txtCampo']):
?>
												<option value="<?php echo $this->_tpl_vars['idCampo']; ?>
"><?php echo $this->_tpl_vars['txtCampo']; ?>
</option>
...
$this->_smarty_include(array('smarty_include_tpl_file' => ($this->_tpl_vars['txtArchivoAyuda']), 'smarty_include_vars' => array()));
				...
				<div id="tabCamposMostrar" class="yui-navset" style="width:100%; text-align:left;">
				    ...
				    <div class="yui-content">
				    	...
				    	<div id="tabReporteadorCampos" style="height:300px; overflow:auto;">
							...
							<div id="txtDivArbolReporteador" style="display:none"><?php echo $this->_tpl_vars['txtJsPostulacion']; ?>
</div>
...
<div id="objReporteadorListener"></div>