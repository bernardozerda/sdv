<?php /* Smarty version 2.6.26, created on 2017-03-23 15:18:34
         compiled from casaMano/postulacion.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'casaMano/postulacion.tpl', 578, false),array('modifier', 'number_format', 'casaMano/postulacion.tpl', 607, false),array('function', 'math', 'casaMano/postulacion.tpl', 579, false),)), $this); ?>
    ...
    <?php else: ?>
        ...
        <!-- OTRO ESQUEMA -->
        <?php $this->assign('txtFuncion', "pedirConfirmacion('mensajes',this,'./contenidos/subsidios/pedirConfirmacionBp.php')"); ?>
        <?php $this->assign('txtImpresion', "imprimirPostulacion( document.frmPostulacion );"); ?>
    <?php endif; ?>
    <!-- ********************************************************** 
            ...
            <div id="frm" style="height:510px;">
                ...
                <table cellspacing="0" cellpadding="3" border="0">
                    <tr>
                        ...
                        <?php if ($this->_tpl_vars['objFormulario']->seqEstadoProceso == 6 || $this->_tpl_vars['objFormulario']->seqEstadoProceso == 7): ?>
                            <select	onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                    ...
                                    style="width:180px;"
                            >
                                <?php $_from = $this->_tpl_vars['arrEstado']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['seqEstadoProceso'] => $this->_tpl_vars['txtEstadoProceso']):
?>
                                    <?php if ($this->_tpl_vars['seqEstadoProceso'] == 6 || $this->_tpl_vars['seqEstadoProceso'] == 7): ?>
                                        <option value="<?php echo $this->_tpl_vars['seqEstadoProceso']; ?>
"
                                        <?php if ($this->_tpl_vars['objFormulario']->seqEstadoProceso == $this->_tpl_vars['seqEstadoProceso']): ?> selected <?php endif; ?>
                                        ><?php echo $this->_tpl_vars['txtEstadoProceso']; ?>
</option>
                                    <?php endif; ?>
...
"
                        ...
                        <?php else: ?>
                            <?php $this->assign('seqEstadoProceso', $this->_tpl_vars['objFormulario']->seqEstadoProceso); ?>
                            <?php echo $this->_tpl_vars['arrEstados'][$this->_tpl_vars['seqEstadoProceso']]; ?>
...
"
                        ...
                        <!--<td style="width:350px;" align="left">
                            <?php if ($this->_tpl_vars['objFormulario']->seqEstadoProceso == 53 || $this->_tpl_vars['objFormulario']->seqEstadoProceso == 54): ?>
                                <select onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                        onBlur="this.style.backgroundColor = '#FFFFFF';" 
                                        name="seqEstadoProceso"
                                        id="seqEstadoProceso"
                                        style="width:350px"
                                        >
                                    <optgroup label="Atras">
                                        <option value="37"><?php echo $this->_tpl_vars['arrEstado']['37']; ?>
</option>
                                    </optgroup>
                                    <optgroup label="Adelante">
                                        <option value="53" <?php if ($this->_tpl_vars['objFormulario']->seqEstadoProceso == 53): ?> selected <?php endif; ?>>
                                            <?php echo $this->_tpl_vars['arrEstado']['53']; ?>

                                        </option>
                                        <option value="54" <?php if ($this->_tpl_vars['objFormulario']->seqEstadoProceso == 54): ?> selected <?php endif; ?>>
                                            <?php echo $this->_tpl_vars['arrEstado']['54']; ?>
...
" 
                        ...
                        <td id="tdlocalidad">
                            <select	onFocus="this.style.backgroundColor = '#ADD8E6';" 
                                    ...
                                    style="width:260px;"
                                    >
                                <option value="1" selected>Seleccione<?php echo $this->_tpl_vars['seqLocalidad']; ?>
a<?php echo $this->_tpl_vars['objFormulario']->seqLocalidad; ?>
</option>
