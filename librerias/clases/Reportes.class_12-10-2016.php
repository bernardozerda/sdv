...
CONVERT(ciu1.txtApellido2 USING utf8)))), ' ', CONVERT(tdo.txtTipoDocumento USING utf8),' ', ciu1.numDocumento, ' ',  civ1.txtEstadocivil, ' ' SEPARATOR' -- ')
FROM T_FRM_HOGAR hog1
INNER JOIN T_CIU_CIUDADANO ciu1 ON hog1.seqCiudadano = ciu1.seqCiudadano
LEFT JOIN T_CIU_ESTADO_CIVIL civ1 ON ciu1.seqEstadoCivil = civ1.seqEstadoCivil
