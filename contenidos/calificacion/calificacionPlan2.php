...
while ($rowPorc = mysql_fetch_array($qryPorcentajes)){
	if ($rowPorc[sigIndicador] == 'IH') $prcIH = $rowPorc[prcIndicador];
	if ($rowPorc[sigIndicador] == 'TDE') $prcTDE = $rowPorc[prcIndicador];
	if ($rowPorc[sigIndicador] == 'ANALF') $prcANALF = $rowPorc[prcIndicador];
	if ($rowPorc[sigIndicador] == 'TamHogar') $prcTamHogar = $rowPorc[prcIndicador];
	if ($rowPorc[sigIndicador] == 'HogMonop') $prcHogMonop = $rowPorc[prcIndicador];
	if ($rowPorc[sigIndicador] == 'PropM14') $prcPropM14 = $rowPorc[prcIndicador];
	if ($rowPorc[sigIndicador] == 'PropMy60') $prcPropMy60 = $rowPorc[prcIndicador];
	if ($rowPorc[sigIndicador] == 'PropDisc') $prcPropDisc = $rowPorc[prcIndicador];
	if ($rowPorc[sigIndicador] == 'ME') $prcME = $rowPorc[prcIndicador];
}
