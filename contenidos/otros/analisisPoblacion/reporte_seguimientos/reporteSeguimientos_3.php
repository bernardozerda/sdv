...
foreach ($lineas as $linea_num => $linea) {
  ...
  FROM    (   (   (   sdht_subsidios.t_seg_seguimiento t_seg_seguimiento
                   INNER JOIN
                      sdht_subsidios.t_ciu_ciudadano t_ciu_ciudadano
                   ON (t_seg_seguimiento.numDocumento =
                          t_ciu_ciudadano.numDocumento))
               INNER JOIN
                  sdht_subsidios.t_seg_gestion t_seg_gestion
               ON (t_seg_seguimiento.seqGestion = t_seg_gestion.seqGestion))
           INNER JOIN
              sdht_subsidios.t_seg_grupo_gestion t_seg_grupo_gestion
           ON (t_seg_gestion.seqGrupoGestion =
                  t_seg_grupo_gestion.seqGrupoGestion))
       INNER JOIN
          sdht_subsidios.t_cor_usuario t_cor_usuario
