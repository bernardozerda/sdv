 ...
 WHERE (ciu.numDocumento IN ($arraydocs));";
    ...
    <table>    
        ...
        <tr>    
            ...
            <td> <a href="https://201.245.171.115/sdv/contenidos/desembolso/formatoRevisionTecnica.php?seqFormulario=' . $resultado->seqFormulario . '">https://201.245.171.115/sdv/contenidos/desembolso/formatoRevisionTecnica.php?seqFormulario=' . $resultado->seqFormulario . '</a> </td>
        <tr>';
            }
        }
