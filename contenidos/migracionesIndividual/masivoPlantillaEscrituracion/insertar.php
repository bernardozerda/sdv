            ...
            foreach ($arreglo['seqFormulario'] as $key => $value) {
                if ($arreglo['seqDesembolso'][$int] != "") {
                    ...
                    <tr>
                        ...
                        <td><a href="http://<?php echo $_SERVER['HTTP_HOST']?>/sdv/contenidos/desembolso/formatoBusquedaOferta.php?seqCasaMano=0&bolEscrituracion=1&seqFormulario=<?= $arreglo['seqFormulario'][$int] ?>">http://<?php echo $_SERVER['HTTP_HOST']?>/sdv/contenidos/desembolso/formatoBusquedaOferta.php?seqCasaMano=0&bolEscrituracion=1&seqFormulario=<?= $arreglo['seqFormulario'][$int] ?></a></td>
                    </tr>
