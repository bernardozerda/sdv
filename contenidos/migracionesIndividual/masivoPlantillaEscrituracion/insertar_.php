            ...
            foreach ($arreglo['seqFormulario'] as $key => $value) {
                if ($arreglo['seqDesembolso'][$int] != "") {
                    ...
                    <tr>
                        ...
                        <td><a href="https://201.245.171.115/sdv/contenidos/desembolso/formatoBusquedaOferta.php?seqCasaMano=0&bolEscrituracion=1&seqFormulario=<?= $arreglo['seqFormulario'][$int] ?>">https://201.245.171.115/sdv/contenidos/desembolso/formatoBusquedaOferta.php?seqCasaMano=0&bolEscrituracion=1&seqFormulario=<?= $arreglo['seqFormulario'][$int] ?></a></td>
                    </tr>
